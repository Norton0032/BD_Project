...
$id = $_GET['id'];
$result = mysqli_query($conn, "SELECT * FROM equipment WHERE id_equipment='$id';");
...
?>
    <div id="info-container">
        ...
        <div id="technical_specifications">Технические характеристики: <?php echo $row['technical_specifications']?></div>
        <div id="quantity">Количество: <?php echo $row['quantity']?></div>
        <div id="id_creator_course">Id создателя курса: <?php echo $row['id_creator_course']?></div>
        <div id="id_provider">Id поставщика: <?php echo $row['id_provider']?></div>
        <div id="links">
            <a href="..">Назад</a>
