...
$id = $_GET['id'];
$result = mysqli_query($conn, "SELECT * FROM provider WHERE id_provider='$id';");
$row = mysqli_fetch_array($result);
$name = $row['first_name'];
$surname = $row['last_name'];
$patronymic = $row['patronymic'];
$phone = $row['phone'];
$list_of_equipment = $row['list_of_equipment'];
?>
    <div id="info-container">
        ...
        <div id="list_of_equipment">Почта: <?php echo $row['list_of_equipment']?></div>
        <div id="links">
            <a href="..">Назад</a>
