...
$id = $_GET['id'];
$result = mysqli_query($conn, "SELECT * FROM candidate_course WHERE id_candidate_course='$id';");
...
?>
    <div id="info-container">
        ...
        <div id="login">Логин: <?php echo $row['login']?></div>
        <div id="password">Пароль: <?php echo $row['password']?></div>
        <div id="links">
            <a href="..">Назад</a>
