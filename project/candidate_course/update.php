...
$id = $_GET['id'];
$humen = mysqli_query($conn, "SELECT * FROM candidate_course WHERE id_candidate_course='$id'");
...
<form action="vendor/update.php" method="post">
    <h2>Обновить информацию о кандидате на работу</h2>
    <input type="hidden" name="id_candidate_course" value="<?php echo $id ?>">
