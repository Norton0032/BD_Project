...
$id = $_GET['id'];
$humen = mysqli_query($conn, "SELECT * FROM renter WHERE id_renter='$id'");
...
<form action="vendor/update.php" method="post">
        <h2>Обновить информацию об арендодателе</h2>
        <input type="hidden" name="id_renter" value="<?php echo $id?>">
