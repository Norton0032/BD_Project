...
if (mysqli_num_rows($check_user) === 0 and mysqli_num_rows($check_admin) === 0 and $login!=="" and $password!=="") {
    mysqli_query($conn, "INSERT INTO creator_course (first_name, last_name, patronymic, phone, email, login, password) VALUES ('$name', '$surname', '$patronymic', '$phone', '$email', '$login', '$password')");
